    ...
    return (
      <div className="w-full">
        {label && (
          <label
            htmlFor={inputId}
            className="block text-[10px] uppercase tracking-[0.15em] font-semibold font-mono text-text-secondary mb-2"
          >
            {label}
        ...
        {helper && !error && (
          <p className="text-text-secondary text-[10px] font-mono mt-1">{helper}</p>
        )}
      </div>
    );
  },
