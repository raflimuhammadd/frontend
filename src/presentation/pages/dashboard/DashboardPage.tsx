        ...
        <Card className="border-border-light">
          <CardHeader className="border-b border-border-light">
            <div className="flex items-center justify-between">
              ...
              <Link href="/projects">
                <Button variant="ghost" size="sm" className="text-[10px] uppercase tracking-wide-15 font-mono">
                  View all
                </Button>
              </Link>
            </div>
            ...
            {recentTasks.length === 0 ? (
              ...
              <div className="divide-y divide-border-light">
                {recentTasks.map(task => (
                  <div key={task.id} className="p-4 hover:bg-hover-bg hover:translate-x-[2px] transition-all">
                    <div className="flex items-start justify-between mb-2">
            ...
            <CardContent className="p-6">
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 bg-brand-dark text-white flex items-center justify-center">
                  <span className="inline-block w-[24px] h-[24px]" data-icon="lucide:check-square-2" data-inline="false" />
                </div>
                <div>
        ...
        <Link href="/projects">
          <Card className="border-border-light hover:border-brand-red transition-colors cursor-pointer h-full">
            <CardContent className="p-6">
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 bg-brand-dark text-white flex items-center justify-center">
                  <span className="inline-block w-[24px] h-[24px]" data-icon="lucide:folder-kanban" data-inline="false" />
                </div>
                <div>
                  <h4 className="text-[13px] uppercase tracking-wide-15 font-semibold font-mono mb-1">
                    Projects
          ...
          <Link href="/admin/audit">
            <Card className="border-border-light hover:border-brand-red transition-colors cursor-pointer h-full">
              <CardContent className="p-6">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-brand-dark text-white flex items-center justify-center">
                    <span className="inline-block w-[24px] h-[24px]" data-icon="lucide:history" data-inline="false" />
                  </div>
                  <div>
                    <h4 className="text-[13px] uppercase tracking-wide-15 font-semibold font-mono mb-1">
                      Audit Trail
